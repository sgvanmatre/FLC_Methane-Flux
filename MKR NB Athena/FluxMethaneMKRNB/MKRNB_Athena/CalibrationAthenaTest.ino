...
if(even){
 ...
 // ----------------------- MOX Data -----------------------------
  ...
  selectI2CChannels(0);
    ...
    doc[String("TEMP_0")] = B_bme.temperature;
    doc[String("Humidity_0")] = B_bme.humidity;
    doc[String("Pressure_0")] = B_bme.pressure;
    doc[String("Gas_0")] = B_bme.gas_resistance / 1000.0;
  ...
  for (uint8_t channel = 0; channel < 6; channel++) {
    ...
    // Add readings to the JSON document
    char channel_str[4];
    itoa(channel, channel_str, 10);
